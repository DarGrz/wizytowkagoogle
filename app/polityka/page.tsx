...
<section>
    <h2>§ 1 Definicje</h2>
<ul>
	<li><p><strong>Serwis</strong> - serwis internetowy działający pod adresem <span id="serwis"><span className="colored">www.dariuszgrzegorczyk.pl</span></span></p></li>
    <li><p><strong>Serwis zewnętrzny</strong> - serwis internetowe partnerów, usługodawców lub usługobiorców Administratora</p></li>
    <li><p><strong>Administrator</strong> - firma <span id="firma"><span className="colored">Dariusz Grzegorczyk</span>, prowadząca działalność pod adresem: <span className="colored">Osiedle Oświecenia 57, 31-636 Kraków</span>, o nadanym numerze identyfikacji podatkowej (NIP): <span className="colored">6782978644</span></span>, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu oraz przechowująca i uzyskująca dostęp do informacji w urządzeniach Użytkownika</p></li>
...
<section>
    ...
    <ul id="cele"><li><p><strong><span className="colored">Usprawnienie i ułatwienie dostępu do Serwisu</span></strong> - Administrator może przechowywać w plikach Cookie informacje o prefernecjach i ustawieniach użytkownika dotyczących Serwisu aby usprawnić, polepszyć i przyśpieszyć świadczenie usług w ramach Serwisu.</p></li><li><p><strong><span className="colored">Marketing i reklama</span></strong> - Administrator <span id="sz3" >oraz Serwisy zewnętrzne</span> wykorzystują pliki Cookie do celów marketingowych oraz serwowania reklam Użytkowników.</p></li><li><p><strong><span className="colored">Dane statystyczne</span></strong> - Administrator <span id="sz4" >oraz Serwisy zewnętrzne</span> wykorzystuje pliki Cookie do zbirania i przetwarzania danych statystycznych takich jak np. statystyki odwiedzin, statystyki Urządzeń Użytkowników czy statystyki zachowań użytkowników. Dane te zbierane są w celu analizy i ulepszania Serwisu.</p></li><li><p><strong><span className="colored">Serwowanie usług multimedialnych</span></strong> - Administrator <span id="sz5" >oraz Serwisy zewnętrzne</span> wykorzystuje pliki Cookie do serwowania Użytkownikom usług multimedialnych.</p></li><li><p><strong><span className="colored">Usługi społecznościowe</span></strong> - Administrator <span id="sz7" >oraz Serwisy zewnętrzne</span> wykorzystują pliki Cookie do wsparcia usług społecznościowych</p></li></ul>
    <h2>§ 5 Serwisy zewnętrzne</h2>
    <p id="zewinfo"><span className="colored">Administrator współpracuje z następującymi serwisami zewnętrznymi, które mogą zamieszczać pliki Cookie na Urządzeniach Użytkownika:</span></p>
    <ul id="zewnetrzne"><li><p><strong><span className="colored">Google Analytics</span></strong></p></li><li><p><strong><span className="colored">Google AdSense</span></strong></p></li><li><p><strong>Google AdWords</strong></p></li> <li><p><strong><span className="colored">Google+</span></strong></p></li><li><p><strong><span className="colored">Facebook</span></strong></p></li><li><p><strong><span className="colored">Twitter</span></strong></p></li><li><p><strong><span className="colored">AddThis</span></strong></p></li><li><p><strong><span className="colored">Youtube</span></strong></p></li><li><p><strong><span className="colored">Vimeo</span></strong></p></li></ul>
</section>
<section>
    <h2>§ 6 Możliwości określania warunków przechowywania i uzyskiwania dostępu na Urządzeniach Użytkownika przez Serwis<span id="sz6"> i Serwisy zewnętrzne</span></h2>
<ul>
...
<section>
    ...
    <ul>
        ...
        <li>Użytkownicy w celu zabezpieczenia się przed wskazanymi w punkcie poprzednim zagrożeniami powinni stosować się do <span id="cyber_random">zasad <a href="https://nety.pl/cyberbezpieczenstwo/zasady-ogolne-korzystania-z-sieci-internet/">bezpiecznego korzystania z sieci</a></span>.</li>
