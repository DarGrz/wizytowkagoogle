  ...
  return (
    <div className="container justify-between items-center items py-12 md:py-24  md:flex flex-col">
        <div className="flex flex-col justify-center gap-3 flex-1 mb-10 md:mb-20 text-center">
            <h1 className="text-6xl  text-center  md:text:6xl lg:text-9xl font-bold main-text-gradient">PROWADZENIE WIZYTÓWEK GOOGLE</h1>
            <p className="text-3xl md:text-5xl m-5 text-center opacity-70 -z-10">Wypromujesz swoją firmę w Mapach Google i wyszukiwarce.</p>
            <div>
              <div className="mt-5">
