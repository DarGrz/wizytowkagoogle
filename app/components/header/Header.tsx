...
const Header = () => {
  return (
    <div className="container justify-between items py-24  md:flex">
        <div className="flex flex-col justify-center gap-3 flex-1 z-10">
            <h1 className="text-5xl text-center md:text-left md:text:6xl lg:text-7xl font-bold main-text-gradient">Twoja Wizytówka Google na Pierszym Miejscu</h1>
